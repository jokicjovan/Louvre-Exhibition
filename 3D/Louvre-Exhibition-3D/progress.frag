...
in vec3 chProgressCoords;        // standardizovane koordinate progressa
...
{                                                                      // float step(float edge, float x);
    float progressColor = step(chProgressCoords.x, 2*uProgressValue);  // vraca 1.0 ako je trenutna koordinata manja ili jednaka progress value, a inace vraca 0.0
